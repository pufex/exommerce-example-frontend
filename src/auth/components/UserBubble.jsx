...
export default function UserBubble () {
    ...
    useEffect(() => {
        const handleOutsideClick = (e) => {
            if(visible && !e.target.closest("#bubble-box")){
                setVisible(false)
            }
        }
    ...
    return auth && <div className="relative">
        <img 
            ...
            alt={auth.user.name}
            className="object-cover object-center w-10 h-10 rounded-full border-3 border-red-800 cursor-pointer"
        />
        {
            visible && <div
                ...
                >
                    ...
                    <ul className="w-full">
                        ...
                        <li className="w-full">
                            <UserBubbleLogout setVisibility={setVisible} />
                        </li>
                    </ul>   
                </div>
        }
